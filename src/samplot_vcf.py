...
if __name__ == "__main__":
    ...
    p.add_argument(
        "-O", "--output-type", choices=("png", "pdf", "eps", "jpg"), help="type of output figure", default="png"
    )
    ...
    p.add_argument(
        "-b", "--bams", type=str, nargs="+", help="Space-delimited list of BAM/CRAM file names", required=True
    )
    p.add_argument(
        "--format", default="AS,AP,DHFFC", help="comma separated list of FORMAT fields to include in sample plot titles"
    )
    p.add_argument(
        "--gff",
